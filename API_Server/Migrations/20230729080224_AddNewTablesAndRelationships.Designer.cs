...
namespace API_Server.Migrations
{
    ...
    [Migration("20230729080224_AddNewTablesAndRelationships")]
    partial class AddNewTablesAndRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Server.Models.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Server.Models.Product", b =>
                {
                    ...
                    b.HasOne("API_Server.Models.Discount", "Discount")
                        .WithMany("Products")
                        .HasForeignKey("DiscountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_Server.Models.Inventory", "Inventory")
                        .WithMany("Products")
